...
const Card = ({ data }) => {
  return (
    <div className="max-w-sm bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 border border-gray-700 rounded-lg shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500 p-5">
      <div className="p-4">
